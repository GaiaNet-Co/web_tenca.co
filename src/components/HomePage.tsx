    ...
    <>
      ...
      <section className={`relative py-32 px-4 sm:px-6 lg:px-8 text-center transition-colors duration-500 overflow-hidden ${activeTheme.classes.hero}`}>
        <div className="absolute inset-0 z-0">
          <ImagePlaceholder src="/images/home.1.jpg" fallbackKeyword="forest,sunlight" className="w-full h-full object-cover opacity-70" alt="ヒーロー背景" />
        </div>
          ...
          <div className="flex flex-col md:flex-row-reverse gap-12 items-center">
            ...
            <div>
              <div className="space-y-4 opacity-90 leading-relaxed">
                ...
                <p>
                  ✔ 長年の不調を根本から整えたい方<br />
                  ✔ 表面的なケアでは満足できなかった方<br />
                  ✔ 自分自身を本質から整えたい方 <br />
                  ✔ 次のステージへ進みたいと感じている方<br />
                  そのような方にこそ、お越しいただきたいと考えています。
                </p>
                <p>
                  ここは、ただ癒される場所ではなく、 本来の自分へと還るための場所。
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <motion.div style={{ y: y1 }} className={`p-8 border transition-colors duration-500 ${activeTheme.classes.card}`}>
              <div className="flex items-center mb-6">
                <div className="w-16 h-16 rounded-full overflow-hidden mr-4 bg-gray-200">
                  <ImagePlaceholder src="/images/voice.woman.jpg" fallbackKeyword="woman,smile" className="w-full h-full object-cover" alt="山田花子" />
                </div>
                <div>
            ...
            <motion.div style={{ y: y2 }} className={`p-8 border transition-colors duration-500 ${activeTheme.classes.card}`}>
              <div className="flex items-center mb-6">
                <div className="w-16 h-16 rounded-full overflow-hidden mr-4 bg-gray-200">
                  <ImagePlaceholder src="/images/voice.woman.jpg" fallbackKeyword="woman,happy" className="w-full h-full object-cover" alt="佐藤雅子" />
                </div>
                <div>
            ...
            <motion.div style={{ y: y3 }} className={`p-8 border transition-colors duration-500 ${activeTheme.classes.card}`}>
              <div className="flex items-center mb-6">
                <div className="w-16 h-16 rounded-full overflow-hidden mr-4 bg-gray-200">
                  <ImagePlaceholder src="/images/voice.woman.jpg" fallbackKeyword="woman,relax" className="w-full h-full object-cover" alt="鈴木明子" />
                </div>
                <div>
